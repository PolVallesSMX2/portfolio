...
export function Astronaut(props) {
  ...
  // targetY holds the desired position; we lerp towards it every frame
  // without involving React state, so FlipWords re-renders never cause a jerk.
  ...
  return (
    <group
        ...
        // position.y is driven entirely by useFrame (lerp), never by props,
        // to avoid the one-frame snap that occurs on every React re-render.
